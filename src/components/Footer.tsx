        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary">Medium</a></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; 2024 RobinHood Crypto Investment Platform. All rights reserved.</p>
          <p className="mt-2">Investment involves risk. Please invest responsibly.</p>
        </div>
      </div>
    </footer>
  );
